(function (translator) {
	translator.translations["jp"] = {
		...
		"paperaddrtype":  { "legacy": "Legacy P2PKH (1…)", "p2sh": "P2SH-P2WPKH (3…)", "segwit": "ネイティブSegWit (bc1q…)", "taproot": "Taproot (bc1p…)" },
		"bulkaddrtype":   { "legacy": "Legacy P2PKH (1…)", "p2sh": "P2SH-P2WPKH (3…)", "segwit": "ネイティブSegWit (bc1q…)", "taproot": "Taproot (bc1p…)" },
		"brainaddrtype":  { "legacy": "Legacy P2PKH (1…)", "p2sh": "P2SH-P2WPKH (3…)", "segwit": "ネイティブSegWit (bc1q…)", "taproot": "Taproot (bc1p…)" },
		"vanityaddrtype": { "legacy": "Legacy P2PKH (1…)", "p2sh": "P2SH-P2WPKH (3…)", "segwit": "ネイティブSegWit (bc1q…)", "taproot": "Taproot (bc1p…)" },
		"splitaddrtype":  { "legacy": "Legacy P2PKH (1…)", "p2sh": "P2SH-P2WPKH (3…)", "segwit": "ネイティブSegWit (bc1q…)", "taproot": "Taproot (bc1p…)" },

		// address type labels
		"paperlabeladdrtype": "アドレスタイプ:",
		"bulklabeladdrtype": "アドレスタイプ:",
		"brainlabeladdrtype": "アドレスタイプ:",
		"vanitylabeladdrtype": "アドレスタイプ:",
		"splitlabeladdrtype": "アドレスタイプ:",
		...
		// status html
		"statuslabelcryptogood": "&#10004; 良い！",
		"statuslabelcryptogood1": "お使いのブラウザはwindow.crypto.getRandomValuesを使用して暗号学的にランダムなキーを生成できます",
		"statusokcryptogood": "OK",
		"statuslabelcryptobad": "&times; 注意！",
		"statuslabelcryptobad1": "お使いのブラウザはwindow.crypto.getRandomValuesをサポートしていません。生成されるキーのセキュリティを高めるため、より新しいブラウザをご使用ください。",
		"statusokcryptobad": "OK",
		"statuslabelunittestsgood": "&#10004; 良い！",
		"statuslabelunittestsgood1": "全ての同期ユニットテストが合格しました。",
		"statusokunittestsgood": "OK",
		"statuslabelunittestsbad": "&times; 注意！",
		"statuslabelunittestsbad1": "一部の同期ユニットテストが合格しませんでした。このジェネレーターには別のブラウザをご使用ください。",
		"statusokunittestsbad": "OK",
		"statuslabelprotocolgood": "&#10004; 良い！",
		"statuslabelprotocolgood1": "ローカルコンピューターからこのジェネレーターを実行しています。<br />ヒント：オフラインであることを確認してください ",
		"statusokprotocolgood": "OK",
		"statuslabelprotocolbad": "&#9888; 慎重に！",
		"statuslabelprotocolbad1": "ライブウェブサイトからオンラインでこのジェネレーターを実行しているようです。価値のあるウォレットには",
		"statuslabelprotocolbad2": "ダウンロード",
		"statuslabelprotocolbad3": "GitHubからzipファイルをダウンロードし、ローカルhtmlファイルとしてオフラインでこのジェネレーターを実行することをお勧めします。",
		"statusokprotocolbad": "OK",
		"statuslabelkeypool1": "これは現在のセッション中に生成した全てのビットコインアドレスとプライベートキーのログです。ページを再読み込みすると新しいセッションが開始されます。",
		"statuskeypoolrefresh": "更新",
		"statusokkeypool": "OK",
		...
		"detaillabelbitcoinaddress": "ビットコインアドレス (Legacy P2PKH)",
		"detaillabelbitcoinaddresscomp": "ビットコインアドレス（圧縮）(Legacy P2PKH)",
		"detaillabelP2SH": "P2SH-P2WPKH アドレス (3…)",
		"detaillabelSegwit": "ネイティブSegWit P2WPKH (bc1q…)",
		...
		"detailbip38encryptbutton": "BIP38で暗号化",
		...
		"detaillabelencrypt": "BIP38で暗号化？",
		"bulklabelBIPpassphrase": "パスワード",
		"brainlabelcompressed": "アドレスを短縮する？",
		"detaillabelprivb6": "秘密鍵 Base6形式 (99文字 [0-5]):",
		"singleshare": "共有",
		"singlesecret": "秘密",
		"detaillabelprivmini": "秘密鍵 ミニ形式 (22, 26, または 30文字、'S'から始まる):"
	};
})(ninja.translator);
