(function (translator) {
	translator.translations["de"] = {
		...
		// footer html
		"donationcopyconfirm": "Adresse kopiert!",
		...
		"singleprint": "Drucken",
		"singlelabeladdrtype": "Adresstyp",
		"singleaddrtype": { "legacy": "Legacy P2PKH (1…)", "p2sh": "P2SH-P2WPKH (3…)", "segwit": "Natives SegWit (bc1q…)", "taproot": "Taproot (bc1p…)" },
		...
		"bulklabelencrypt": "BIP38-Verschlüsselung?",
		"detaillabelencrypt": "BIP38-Verschlüsselung?",
		"bulklabelBIPpassphrase": "Passwort:",
		"brainlabelcompressed": "Komprimierte Adresse?",
		"detailwifprefix": "'5'",
		"detaillabelprivb6": "Privater Schlüssel Base6-Format (99 Zeichen [0-5]):"
	};
})(ninja.translator);
