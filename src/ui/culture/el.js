(function (translator) {
	translator.translations["el"] = {
		...
		// footer html
		"donationcopyconfirm": "Διεύθυνση αντιγράφηκε!",
		...
		"singlelabeladdrtype": "Τύπος διεύθυνσης",
		"singleaddrtype": { "legacy": "Legacy P2PKH (1…)", "p2sh": "P2SH-P2WPKH (3…)", "segwit": "Εγγενές SegWit (bc1q…)", "taproot": "Taproot (bc1p…)" },
		"singlelabelprivatekey": "Προσωπικό Κλειδί (WIF συμπιεσμένο)",
		...
		"paperprint": "Εκτύπωση",
		"paperlabelBIPpassphrase": "Κωδικός πρόσβασης:",
		...
		"vanitylabelstep1privatekey": "Βήμα 1 Προσωπικό Κλειδί:",
		...
		"detailkeyformats": "Μορφές Κλειδιού: WIF, WIFC, HEX, B64, B6, MINI, BIP38",
		...
		"bulklabelBIPpassphrase": "Κωδικός πρόσβασης:",
		"brainlabelcompressed": "Συμπιεσμένη διεύθυνση;",
		"detailwifprefix": "'5'",
		"detaillabelprivb6": "Προσωπικό κλειδί μορφή Base6 (99 χαρακτήρες [0-5]):"
	};
})(ninja.translator);
